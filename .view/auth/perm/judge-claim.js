...
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+""}function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;var pug_debug_filename, pug_debug_line;try {;
    ...
    (function (Array, JSON, b64img, blockLoader, cssLoader, ctrl, decache, escape, escjson, parentName, prefix, scriptLoader, version) {
...
pug_html = pug_html + "\u003Cscript\u003E";
;pug_debug_line = 9;pug_debug_filename = "src\u002Fpug\u002Fauth\u002Fperm\u002Fjudge-claim.pug";
pug_html = pug_html + "\u002F\u002F Generated by LiveScript 1.3.0\nldc.register(['ldcvmgr', 'loader', 'error', 'auth', 'viewLocals'], function(arg$){\n  var ldcvmgr, loader, error, auth, viewLocals;\n  ldcvmgr = arg$.ldcvmgr, loader = arg$.loader, error = arg$.error, auth = arg$.auth, viewLocals = arg$.viewLocals;\n  return auth.ensure({\n    info: 'token',\n    forceEmail: (viewLocals.email || \"\").toLowerCase()\n  }).then(function(g){\n    return auth.recaptcha.get();\n  }).then(function(recaptcha){\n    var payload;\n    payload = {\n      token: viewLocals.token,\n      recaptcha: recaptcha\n    };\n    loader.on();\n    return ld$.fetch('\u002Fdash\u002Fapi\u002Fjudgetoken', {\n      method: 'PUT'\n    }, {\n      json: payload\n    })['finally'](function(){\n      return loader.off();\n    }).then(function(){\n      return ldcvmgr.toggle('judge-claimed');\n    });\n  })['catch'](function(e){\n    if (ldError.id(e) === 1013) {\n      return ldcvmgr.toggle('perm-fail');\n    }\n    return ldcvmgr.getdom('denied').then(function(dom){\n      var view;\n      return view = new ldView({\n        root: dom,\n        handler: {\n          email: function(arg$){\n            var node;\n            node = arg$.node;\n            return node.innerText = viewLocals.email;\n          },\n          reauth: function(arg$){\n            var node;\n            node = arg$.node;\n            return node.setAttribute('href', \"\u002Fdash\u002Fme\u002Freauth\u002F?nexturl=\" + window.location.href);\n          }\n        }\n      });\n    }).then(function(){\n      return ldcvmgr.toggle('denied');\n    });\n  });\n});\u003C\u002Fscript\u003E";
;pug_debug_line = 31;pug_debug_filename = "src\u002Fpug\u002Fauth\u002Fperm\u002Fjudge-claim.pug";
...
pug_html = pug_html + "\u003C\u002Fbody\u003E\u003C\u002Fhtml\u003E";
        ...
        typeof escjson !== 'undefined' ? escjson : undefined, "parentName" in locals_for_with ?
