...
(function(){
  var startTime, fs, fsExtra, path, crypto, LiveScript, chokidar, moment, express, bodyParser, expressSession, connectMultiparty, csurf, expressRateLimit, passport, passportLocal, passportFacebook, passportGoogleOauth20, nodemailer, sharedbWrapper, lderror, postgresql, api, ext, view, cache, aux, throttle, grecaptcha, watch, secret, mod, uglifyJs, lsc, config, colors, modBuilder, customBuilder, backend;
  startTime = Date.now();
  fs = require('fs');
  ...
  backend = {
    ...
    init: function(){
      ...
      return new Promise(function(res, rej){
        var pgsql, authio, ref$, csp, cors, enable, ip, app, getUser, sessionStore, session, access, server, sdb, connect, wss, router, x$, y$, multi, initedTime;
