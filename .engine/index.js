...
(function(){
  var startTime, fs, fsExtra, path, crypto, LiveScript, chokidar, moment, express, bodyParser, expressSession, connectMultiparty, csurf, expressRateLimit, passport, passportLocal, passportFacebook, passportGoogleOauth20, nodemailer, sharedbWrapper, lderror, postgresql, api, ext, view, cache, aux, watch, secret, mod, uglifyJs, lsc, config, colors, modBuilder, customBuilder, backend;
  startTime = Date.now();
  fs = require('fs');
