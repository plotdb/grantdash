...
(function(){
  var crypto, aux, throttle, mail, grecaptcha;
  ...
  (function(it){
    ...
    engine.router.api.post('/me/passwd/reset/:token', throttle.count.ipMd, grecaptcha, function(req, res){
      var token, password;
    ...
    engine.app.get('/me/passwd/reset/:token', throttle.count.ipMd, function(req, res){
      var token;
      token = req.params.token;
      if (!token) {
    ...
    return engine.router.api.post('/me/passwd/reset', throttle.count.action.mail, function(req, res){
      var email, obj;
