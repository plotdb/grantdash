...
(function(){
  var fs, path, lderror, aux, permcache;
  fs = require('fs');
  path = require('path');
  ...
  (function(it){
    ...
    return api.post('/toc', aux.signed, function(req, res){
      ...
      promise = hint.brd
        ? permcache.check((ref$ = import$({}, permOpt), ref$.type = 'brd', ref$.slug = hint.brd, ref$)).then(function(){
          ...
          return permcache.check((ref$ = import$({}, permOpt), ref$.type = 'org', ref$.slug = lc.brd.org, ref$)).then(function(){
        ...
        : hint.org
          ? permcache.check((ref$ = import$({}, permOpt), ref$.type = 'org', ref$.slug = hint.org, ref$)).then(function(){
