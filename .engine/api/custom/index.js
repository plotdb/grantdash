...
(function(){
  var fs, fsExtra, path, crypto, lderror, suuid, mimeTypes, puppeteer, tmp, easyPdfMerge, request, aux, cache, common, printer, grecaptcha, throttle, storage, secret, jsdom, dompurify, window, purify;
  fs = require('fs');
  ...
  window = new jsdom.JSDOM("<!DOCTYPE html>").window;
  ...
  (function(it){
    ...
    return api.post('/custom/print', throttle.count.user, grecaptcha, function(req, res){
      var lc, html;
      lc = {};
      html = purify.sanitize(req.body.html) || "";
