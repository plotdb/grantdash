...
ldc.register('prjView', ['auth', 'error', 'viewLocals', 'discussView', 'discussEdit'], function(arg$){
  var auth, error, discussView, discussEdit, viewLocals;
  auth = arg$.auth, error = arg$.error, discussView = arg$.discussView, discussEdit = arg$.discussEdit, viewLocals = arg$.viewLocals;
  return auth.get().then(function(g){
    var prj, brd, grp, answers, ref$, blocks, bhash, discuss, view;
