...
ldc.register(['stage', 'general', 'ldcvmgr', 'adminInfo', 'prjCreate', 'auth', 'error', 'loader', 'general'], function(arg$){
  var stage, general, ldcvmgr, adminInfo, prjCreate, auth, error, loader, lc, key;
  stage = arg$.stage, general = arg$.general, ldcvmgr = arg$.ldcvmgr, adminInfo = arg$.adminInfo, prjCreate = arg$.prjCreate, auth = arg$.auth, error = arg$.error, loader = arg$.loader, general = arg$.general;
  loader.on();
  lc = {};
