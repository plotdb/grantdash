...
(function(){
  ldc.register('prjForm', ['prjFormCriteria', 'prjFormBlock', 'prjFormValidation'], function(arg$){
    var prjFormCriteria, prjFormBlock, prjFormValidation, viewMode, lc, hub, bmgr, fillData, validate, update, blocksView, n, reb, progress, viewer, renderAnswer, viewAnswer;
