...
var slice$ = [].slice;
ldc.register('prjForm', ['error', 'ldcvmgr', 'prjFormCriteria', 'prjFormBlock', 'prjFormValidation', 'sdbAdapter'], function(arg$){
  var error, ldcvmgr, prjFormCriteria, prjFormBlock, prjFormValidation, sdbAdapter, Ctrl;
  error = arg$.error, ldcvmgr = arg$.ldcvmgr, prjFormCriteria = arg$.prjFormCriteria, prjFormBlock = arg$.prjFormBlock, prjFormValidation = arg$.prjFormValidation, sdbAdapter = arg$.sdbAdapter;
  Ctrl = function(opt){
