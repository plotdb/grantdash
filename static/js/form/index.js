...
var slice$ = [].slice;
ldc.register('prjForm', ['error', 'ldcvmgr', 'prjFormCriteria', 'prjFormBlock', 'prjFormValidation', 'prjViewSimple', 'sdbAdapter'], function(arg$){
  var error, ldcvmgr, prjFormCriteria, prjFormBlock, prjFormValidation, prjViewSimple, sdbAdapter, Ctrl;
  error = arg$.error, ldcvmgr = arg$.ldcvmgr, prjFormCriteria = arg$.prjFormCriteria, prjFormBlock = arg$.prjFormBlock, prjFormValidation = arg$.prjFormValidation, prjViewSimple = arg$.prjViewSimple, sdbAdapter = arg$.sdbAdapter;
  Ctrl = function(opt){
    var root, viewMode, obj, titleBlock, descriptionBlock, lc, hub, bmgr, blocksView, reb, progress, viewer, prjView, viewAnswerDiff, this$ = this;
    this.opt = opt;
