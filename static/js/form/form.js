...
(function(){
  var criteria, criteriaRender, renderList, formModules, blockRenderer, blocks, blocksView, bmgr, reb;
  criteria = {
    types: {
      "number": {
        name: "數值",
        ...
        list: {
          ...
          init: function(arg$){
            ...
            return node.view = view = new ldView({
              ...
              action: {
                input: {
                  "list-title": function(arg$){
                    var node;
                    node = arg$.node;
                    return data.title = node.innerText;
                  },
                  "list-description": function(arg$){
                    var node;
                    node = arg$.node;
                    return data.description = node.innerText;
                  }
                }
              },
              handler: {
                ...
                "list-description": function(arg$){
                  var node;
                  node = arg$.node;
                  return node.innerText = data.description;
                }
              }
            });
          },
