...
ldc.register(['ldcvmgr', 'sdbAdapter', 'loader', 'error'], function(arg$){
  var ldcvmgr, sdbAdapter, loader, error, Ctrl, ret, slug, ctrl;
  ldcvmgr = arg$.ldcvmgr, sdbAdapter = arg$.sdbAdapter, loader = arg$.loader, error = arg$.error;
  Ctrl = function(opt){
    var this$ = this;
    this.opt = opt;
