...
ldc.register('adminGuard', ['general', 'ldcvmgr', 'auth', 'loader', 'sdbAdapter', 'error', 'adminMenu', 'adminPanel', 'adminInfo', 'adminStage', 'adminPerm', 'adminNavbar', 'adminPrjList', 'prjForm', 'adminEntry', 'adminWelcome', 'adminPage'], function(arg$){
  var general, ldcvmgr, auth, loader, sdbAdapter, error, adminMenu, adminPanel, adminInfo, adminStage, adminPerm, adminNavbar, adminPrjList, prjForm, adminEntry, adminWelcome, adminPage, Ctrl, ctrl;
  general = arg$.general, ldcvmgr = arg$.ldcvmgr, auth = arg$.auth, loader = arg$.loader, sdbAdapter = arg$.sdbAdapter, error = arg$.error, adminMenu = arg$.adminMenu, adminPanel = arg$.adminPanel, adminInfo = arg$.adminInfo, adminStage = arg$.adminStage, adminPerm = arg$.adminPerm, adminNavbar = arg$.adminNavbar, adminPrjList = arg$.adminPrjList, prjForm = arg$.prjForm, adminEntry = arg$.adminEntry, adminWelcome = arg$.adminWelcome, adminPage = arg$.adminPage;
  Ctrl = function(){
    var this$ = this;
    this.loader = loader;
    this.hubs = null;
