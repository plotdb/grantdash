...
var slice$ = [].slice;
ldc.register('adminGuard', ['auth', 'loader', 'sdbAdapter', 'adminMenu', 'adminPanel', 'adminInfo', 'adminStage', 'adminPerm'], function(arg$){
  var auth, loader, sdbAdapter, adminMenu, adminPanel, adminInfo, adminStage, adminPerm, init, Hub, prepareSharedb;
  auth = arg$.auth, loader = arg$.loader, sdbAdapter = arg$.sdbAdapter, adminMenu = arg$.adminMenu, adminPanel = arg$.adminPanel, adminInfo = arg$.adminInfo, adminStage = arg$.adminStage, adminPerm = arg$.adminPerm;
  loader.on();
