...
ldc.register('adminGuard', ['navtop', 'ldcvmgr', 'auth', 'loader', 'sdbAdapter', 'error', 'adminMenu', 'adminPanel', 'adminInfo', 'adminStage', 'adminPerm', 'adminNavbar', 'adminPrjList', 'prjForm', 'adminEntry', 'adminWelcome', 'adminPage', 'adminPrjDetail', 'adminPostList', 'adminJudgePerm', 'adminJudgeCriteria', 'adminJudgePrimary'], function(arg$){
  var navtop, ldcvmgr, auth, loader, sdbAdapter, error, adminMenu, adminPanel, adminInfo, adminStage, adminPerm, adminNavbar, adminPrjList, prjForm, adminEntry, adminWelcome, adminPage, adminPrjDetail, adminPostList, adminJudgePerm, adminJudgeCriteria, adminJudgePrimary, Ctrl, ctrl;
  navtop = arg$.navtop, ldcvmgr = arg$.ldcvmgr, auth = arg$.auth, loader = arg$.loader, sdbAdapter = arg$.sdbAdapter, error = arg$.error, adminMenu = arg$.adminMenu, adminPanel = arg$.adminPanel, adminInfo = arg$.adminInfo, adminStage = arg$.adminStage, adminPerm = arg$.adminPerm, adminNavbar = arg$.adminNavbar, adminPrjList = arg$.adminPrjList, prjForm = arg$.prjForm, adminEntry = arg$.adminEntry, adminWelcome = arg$.adminWelcome, adminPage = arg$.adminPage, adminPrjDetail = arg$.adminPrjDetail, adminPostList = arg$.adminPostList, adminJudgePerm = arg$.adminJudgePerm, adminJudgeCriteria = arg$.adminJudgeCriteria, adminJudgePrimary = arg$.adminJudgePrimary;
  Ctrl = function(){
    var this$ = this;
    this.loader = loader;
    this.hubs = null;
