...
ldc.register('adminGuard', ['ldcvmgr', 'auth', 'loader', 'sdbAdapter', 'error', 'adminMenu', 'adminPanel', 'adminInfo', 'adminStage', 'adminPerm', 'adminNavbar', 'adminPrjList', 'prjForm', 'adminEntry', 'adminWelcome', 'adminPage'], function(arg$){
  var ldcvmgr, auth, loader, sdbAdapter, error, adminMenu, adminPanel, adminInfo, adminStage, adminPerm, adminNavbar, adminPrjList, prjForm, adminEntry, adminWelcome, adminPage, Ctrl, ctrl;
