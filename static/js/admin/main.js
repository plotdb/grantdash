...
var slice$ = [].slice;
ldc.register('adminGuard', ['auth', 'loader', 'sdbAdapter', 'adminMenu', 'adminPanel', 'adminInfo', 'adminStage', 'adminPerm', 'adminNavbar', 'prjForm'], function(arg$){
  var auth, loader, sdbAdapter, adminMenu, adminPanel, adminInfo, adminStage, adminPerm, adminNavbar, prjForm, init, Hub, prepareSharedb;
  auth = arg$.auth, loader = arg$.loader, sdbAdapter = arg$.sdbAdapter, adminMenu = arg$.adminMenu, adminPanel = arg$.adminPanel, adminInfo = arg$.adminInfo, adminStage = arg$.adminStage, adminPerm = arg$.adminPerm, adminNavbar = arg$.adminNavbar, prjForm = arg$.prjForm;
  loader.on();
  ...
  init = function(toc){
    ...
    return prepareSharedb(toc).then(function(arg$){
      var org, brd, menu, info, stage, perm, navbar, form;
