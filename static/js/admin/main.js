...
ldc.register('adminGuard', ['general', 'navtop', 'ldcvmgr', 'auth', 'loader', 'sdbAdapter', 'error', 'adminMenu', 'adminPanel', 'adminInfo', 'adminStage', 'adminPerm', 'adminNavbar', 'adminPrjList', 'prjForm', 'adminEntry', 'adminWelcome', 'adminPage', 'adminPrjDetail', 'adminPostList'], function(arg$){
  var general, navtop, ldcvmgr, auth, loader, sdbAdapter, error, adminMenu, adminPanel, adminInfo, adminStage, adminPerm, adminNavbar, adminPrjList, prjForm, adminEntry, adminWelcome, adminPage, adminPrjDetail, adminPostList, Ctrl, ctrl;
