...
ldc.register('adminGuard', ['navtop', 'ldcvmgr', 'auth', 'loader', 'sdbAdapter', 'error', 'adminMenu', 'adminPanel', 'adminInfo', 'adminStage', 'adminPerm', 'adminNavbar', 'adminPrjList', 'prjForm', 'adminEntry', 'adminWelcome', 'adminPage', 'adminPrjDetail', 'adminPostList', 'adminJudgePerm', 'adminJudgeCriteria', 'adminJudgePrimary', 'adminJudgeFinal', 'adminDev', 'adminJudgeCustom'], function(arg$){
  var navtop, ldcvmgr, auth, loader, sdbAdapter, error, adminMenu, adminPanel, adminInfo, adminStage, adminPerm, adminNavbar, adminPrjList, prjForm, adminEntry, adminWelcome, adminPage, adminPrjDetail, adminPostList, adminJudgePerm, adminJudgeCriteria, adminJudgePrimary, adminJudgeFinal, adminDev, adminJudgeCustom, Ctrl, ctrl;
  navtop = arg$.navtop, ldcvmgr = arg$.ldcvmgr, auth = arg$.auth, loader = arg$.loader, sdbAdapter = arg$.sdbAdapter, error = arg$.error, adminMenu = arg$.adminMenu, adminPanel = arg$.adminPanel, adminInfo = arg$.adminInfo, adminStage = arg$.adminStage, adminPerm = arg$.adminPerm, adminNavbar = arg$.adminNavbar, adminPrjList = arg$.adminPrjList, prjForm = arg$.prjForm, adminEntry = arg$.adminEntry, adminWelcome = arg$.adminWelcome, adminPage = arg$.adminPage, adminPrjDetail = arg$.adminPrjDetail, adminPostList = arg$.adminPostList, adminJudgePerm = arg$.adminJudgePerm, adminJudgeCriteria = arg$.adminJudgeCriteria, adminJudgePrimary = arg$.adminJudgePrimary, adminJudgeFinal = arg$.adminJudgeFinal, adminDev = arg$.adminDev, adminJudgeCustom = arg$.adminJudgeCustom;
  Ctrl = function(){
    var this$ = this;
    this.loader = loader;
    this.hubs = null;
  ...
  Ctrl.prototype = import$(Object.create(Object.prototype), {
    ...
    setGroup: function(v, forceAdapt){
      ...
      return (function(){
        ...
        if (this$.ctrl.grp[k].setData) {
          this$.ctrl.grp[k].setData(this$.grp);
        }
        if (!this$.ctrl.grp[k].adapt) {
          return;
        }
        p = ['group', idx];
        p = p.concat((that = this$.ctrl.grp[k].path)
          ? that
          : [k]);
    ...
    initCtrl: function(){
      ...
      this.ctrl.dev = new adminDev({});
      this.ctrl.welcome = new adminWelcome({
        root: '[ld-scope=admin-welcome]',
        toc: toc
      });
      this.ctrl.posts = new adminPostList({
        root: '[ld-scope=admin-post-list]',
        brd: toc.brd
      });
      x$ = this.ctrl.org;
      ...
      z$.judgePerm = new adminJudgePerm({
        root: '[ld-scope=judge-perm]',
        toc: toc,
        brd: toc.brd
      });
      z$.judgeCriteria = new adminJudgeCriteria({
        root: '[ld-scope=judge-criteria]',
        toc: toc,
        brd: toc.brd,
        path: ['judge', 'criteria']
      });
      z$.judgePrimary = new adminJudgePrimary({
        root: '[ld-scope=judge-primary]',
        toc: toc,
        brd: toc.brd,
        path: ['judge', 'primary']
      });
      z$.judgeFinal = new adminJudgeFinal({
        root: '[ld-scope=judge-final]',
        toc: toc,
        brd: toc.brd,
        path: ['judge', 'final']
      });
      ...
      return this.ctrl.grp.list.on('set-prj', function(it){
        return this$.ctrl.prj.main.setPrj(it);
      });
    },
    publish: function(){
      var this$ = this;
