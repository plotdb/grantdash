...
(function(){
  ldc.register('adminGuard', ['auth', 'loader', 'adminPanel', 'sdbAdapter'], function(arg$){
    var auth, loader, adminPanel, sdbAdapter, init, sdb, menu;
    auth = arg$.auth, loader = arg$.loader, adminPanel = arg$.adminPanel, sdbAdapter = arg$.sdbAdapter;
    loader.on();
    ...
    init = function(toc){
      ...
      return sdb(toc).then(function(it){
        return menu(toc, it);
      });
    };
    sdb = function(toc){
      ...
      prepare = function(){
        ...
        return sdb.get({
          ...
          return console.log(toc.doc.brd.data);
        }).then(function(){
          return sdb;
        })['catch'](function(){
