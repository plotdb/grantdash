...
ldc.register('adminPage', ['auth', 'error', 'sdbAdapter', 'ldcvmgr'], function(arg$){
  var auth, sdbAdapter, error, ldcvmgr, Ctrl;
  auth = arg$.auth, sdbAdapter = arg$.sdbAdapter, error = arg$.error, ldcvmgr = arg$.ldcvmgr;
  Ctrl = function(opt){
