...
(function(){
  ldc.register('admin', ['permctrl', 'navbar', 'grpSidemenu', 'adminNavigation', 'viewLocals', 'orgInfo', 'brdInfo', 'prjInfo', 'loader', 'util'], function(arg$){
    var permctrl, navbar, grpSidemenu, adminNavigation, viewLocals, orgInfo, brdInfo, prjInfo, loader, util, lc, permPanel, permctrlOpt, permctrlAdopter, orgPermctrlOpt, orgPermctrlAdopter, prjPermctrlOpt, prjPermctrlAdopter, navbarPanel, brdNavbarOpt, brdNavbarAdopter, sdb, watch, ret, that, id, init, watchBoard, initBoard;
    permctrl = arg$.permctrl, navbar = arg$.navbar, grpSidemenu = arg$.grpSidemenu, adminNavigation = arg$.adminNavigation, viewLocals = arg$.viewLocals, orgInfo = arg$.orgInfo, brdInfo = arg$.brdInfo, prjInfo = arg$.prjInfo, loader = arg$.loader, util = arg$.util;
    loader.on();
    lc = {};
