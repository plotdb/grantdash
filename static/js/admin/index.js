...
(function(){
  ldc.register('admin', ['viewLocals', 'orgInfo', 'orgPerm', 'loader'], function(arg$){
    var viewLocals, orgInfo, orgPerm, loader, lc, sdb, watch, update, ret, id, init;
    viewLocals = arg$.viewLocals, orgInfo = arg$.orgInfo, orgPerm = arg$.orgPerm, loader = arg$.loader;
    loader.on();
    lc = {};
    /*
