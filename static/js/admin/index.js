...
(function(){
  ldc.register('admin', ['permctrl', 'navbar', 'adminNavigation', 'viewLocals', 'orgInfo', 'brdInfo', 'prjInfo', 'loader', 'util'], function(arg$){
    var permctrl, navbar, adminNavigation, viewLocals, orgInfo, brdInfo, prjInfo, loader, util, lc, permPanel, path, permctrlOpt, permctrlAdopter, orgPermctrlOpt, orgPermctrlAdopter, navbarPanel, brdNavbarOpt, brdNavbarAdopter, sdb, watch, ret, that, id, init, prjgView, watchBoard, initBoard;
    permctrl = arg$.permctrl, navbar = arg$.navbar, adminNavigation = arg$.adminNavigation, viewLocals = arg$.viewLocals, orgInfo = arg$.orgInfo, brdInfo = arg$.brdInfo, prjInfo = arg$.prjInfo, loader = arg$.loader, util = arg$.util;
    loader.on();
    lc = {};
