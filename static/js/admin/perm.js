...
ldc.register('adminPerm', ['ldcvmgr', 'sdbAdapter', 'userSearch', 'error'], function(arg$){
  var ldcvmgr, sdbAdapter, userSearch, error, Ctrl;
  ldcvmgr = arg$.ldcvmgr, sdbAdapter = arg$.sdbAdapter, userSearch = arg$.userSearch, error = arg$.error;
  Ctrl = function(opt){
