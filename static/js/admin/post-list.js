...
ldc.register('adminPostList', ['notify', 'loader', 'ldcvmgr', 'error', 'adminPanel'], function(arg$){
  var notify, loader, ldcvmgr, error, adminPanel, Ctrl;
  notify = arg$.notify, loader = arg$.loader, ldcvmgr = arg$.ldcvmgr, error = arg$.error, adminPanel = arg$.adminPanel;
  Ctrl = function(opt){
    var root, this$ = this;
    this.opt = opt;
