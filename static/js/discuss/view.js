...
ldc.register('discussView', ['discussEdit', 'auth', 'error'], function(arg$){
  var discussEdit, auth, error, Ctrl;
  discussEdit = arg$.discussEdit, auth = arg$.auth, error = arg$.error;
  Ctrl = function(opt){
            ...
            return view = new ldView({
              ...
              handler: {
                'delete': function(arg$){
                  var node;
                  node = arg$.node;
                  return node.classList.toggle('d-none', !(data.owner === this$.global.user.key || this$.global.user.staff));
                },
                avatar: function(arg$){
                  var node;
                  node = arg$.node;
